...
const transporter = nodemailer.createTransport({
    ...
    port: 587,
    auth: {
        user: 'keshaun.gutmann@ethereal.email',
        pass: 'VN3bwKE6AKEep4uVYx'
    }
});
...
<table role="presentation" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td class="content-block">
      <span class="apple-link">Shop Paris</span>
    </td>
  </tr>
  <tr>
...
const sendMailRegistration = async function(data) {
    let html = `
    ${style}
      <body>
        <span class="preheader">Nuevo Registro.</span>
...
const sendMsgShopAdmin = async function(usuario) {
    client.messages
          .create({
             from: 'whatsapp:+14155238886 ',
...
module.exports = { sendMailRegistration, sendMailShop, sendMsgShop, sendMsgShopAdmin }